...
//   const [server] = useState("http://192.168.1.100");
...
//       setYolo(yoloFlag);
//       try {
//         const response = await axios.get(`${server}:5000/stream-id`, {
//           params: { rtspAddr: rtspAddr },
//         });
//         const { streamId } = response.data;
//         setStreamId(streamId);
//         setStreamSrc(
//           `${server}:5000/stream/${streamId}?rtspAddr=${rtspAddr}&yolo=${yoloFlag}`
//           // 
//         );
//       } catch (error) {
...
//     try {
//       if (streamId) {
//         await axios.post(`${server}:5000/stop-stream`, { streamId });
...
//              (<>
//              <img 
//                 src={`http://${server}:5002/get_frame2?instl_pos=${instlPos}&date_folder=${date}&hour_folder=${hour}&minute=00&frame_time=2.5`}
//                 alt="Frame Image"
//                 style={{
//                   width: "100%",
//                   height: "auto",
...
//               (<>
//                 <img 
//                     src={`http://${server}:5002/get_frame2?instl_pos=${instlPos}&date_folder=${date}&hour_folder=${hour}&minute=30&frame_time=2.5`}
//                     alt="Frame Image"
//                     style={{
//                       width: "100%",
//                       height: "auto",
...
//                 (<>
//                     <img 
//                     src={`http://${server}:5002/get_frame2?instl_pos=${instlPos}&date_folder=${date}&hour_folder=${hour}&minute=60&frame_time=2.5`}
//                     alt="Frame Image"
//                     style={{
//                       width: "100%",
//                       height: "auto",
